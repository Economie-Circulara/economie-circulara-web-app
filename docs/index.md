...
| [contract-draft-client-paas.pdf](contract-draft-client-paas.pdf)   | Draft de contract cu un client platitor al platformei: modelul PaaS „beton ca serviciu" — abonamente, pay-per-use, module platforma.                   |
| [analiza-contract-client-paas.md](analiza-contract-client-paas.md) | **Red flags** din draftul de contract (de negociat inainte de semnare: „timp real", CO2 „automat") + cerintele de produs rezultate (abonamente, raport sustenabilitate). |
