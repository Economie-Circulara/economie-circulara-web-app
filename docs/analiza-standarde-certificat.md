...
| Footer                     | "Certificat generat automat", "Graful reflectă trasabilitatea inregistrată în platformă la data emiterii.", caseta de semnatura cu `orgName` + "Semnătură & ștampilă electronică", banda "{orgName} · trasabilitate emisă de Lateris Trace" |
...
> înregistrate de emitent în platforma Lateris Trace. Descrie lanțul de loturi de materiale
...
> integral emitentului. Lateris Trace este furnizorul platformei software; **nu verifică, nu
